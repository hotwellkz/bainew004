        ...
        <div className="grid gap-2">
          {suggestedQuestions.map((question, index) => (
            <button
              ...
              className="text-left hover:bg-gray-800 p-3 rounded-lg transition-colors flex items-center gap-2"
      ...
      <div className="bg-gray-900/50 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <textarea
            ...
            className="w-full bg-gray-800 rounded-lg p-4 min-h-[100px] resize-y"
          />
